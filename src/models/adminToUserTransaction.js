module.exports = (sequelize, DataTypes) => {
  return sequelize.define('adminToUserTransaction', {
    id: {
    ...
    adminSender: { // UUID de l'expéditeur (admin)
      type: DataTypes.UUID,
      allowNull: false,
      validate: {
        isUUID: {
    ...
    userReceiver: { // UUID du destinataire (user)
      type: DataTypes.UUID,
      allowNull: false,
      validate: {
        isUUID: {
  ...
  validate: {
    ...
    type: {
      ...
      allowNull: false,
      defaultValue: 'admin-to-user',
      validate: {
        isIn: {
          args: [['admin-to-user']],
          msg: 'Le type doit être "admin-to-user".'
        },
